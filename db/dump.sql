...
INSERT INTO `conv` VALUES (1,'chung ta'),(2,'chung ta'),(3,'chung ta'),(4,'dfsfd');
...
DROP TABLE IF EXISTS `grp_mem`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `grp_mem` (
  `cntc_id` bigint(20) NOT NULL,
  `conv_id` bigint(20) NOT NULL,
  `jnd_dtm` timestamp NULL DEFAULT NULL,
  `lft_dtm` timestamp NULL DEFAULT NULL,
  KEY `grp_mem_user_account_id_fk` (`cntc_id`),
  KEY `grp_mem_conv_id_fk` (`conv_id`),
  CONSTRAINT `grp_mem_conv_id_fk` FOREIGN KEY (`conv_id`) REFERENCES `conv` (`id`),
  CONSTRAINT `grp_mem_user_account_id_fk` FOREIGN KEY (`cntc_id`) REFERENCES `user_account` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `grp_mem`
--

LOCK TABLES `grp_mem` WRITE;
/*!40000 ALTER TABLE `grp_mem` DISABLE KEYS */;
/*!40000 ALTER TABLE `grp_mem` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `label` VALUES (1,4,'{\"backgroundColor\":\"#5f3811\",\"color\":\"#b6c2cf\"}','Bug',NULL,'2023-05-08 15:41:39','\0','huyvu8051@gmail.com','2023-05-29 15:15:13'),(2,4,'{\"backgroundColor\":\"#60c6d2\",\"color\":\"#1d2125\"}','Feature',NULL,'2023-05-08 15:41:39','\0','huyvu8051@gmail.com','2023-05-29 15:22:58'),(3,4,'{}','Help wanted',NULL,'2023-05-08 15:41:39','\0',NULL,'2023-05-29 14:30:28'),(4,4,'{\"backgroundColor\":\"#4bce97\",\"color\":\"#1d2125\"}','Invalid',NULL,'2023-05-08 15:41:39','\0','huyvu8051@gmail.com','2023-05-30 08:15:11'),(5,4,'{}','Wontfix',NULL,'2023-05-08 15:41:39','\0',NULL,'2023-05-29 14:30:28'),(6,4,'{\"backgroundColor\":\"#f87462\",\"color\":\"#1d2125\"}','Documentation',NULL,'2023-05-08 15:41:39','\0','huyvu8051@gmail.com','2023-05-29 15:45:24'),(7,4,'{\"backgroundColor\":\"#50253f\",\"color\":\"#b6c2cf\"}','No comments',NULL,'2023-05-23 09:10:39','\0','huyvu8051@gmail.com','2023-05-29 15:45:28'),(8,4,'{\"backgroundColor\":\"#974f0c\",\"color\":\"#b6c2cf\"}','Unchecked',NULL,'2023-05-23 10:29:48','\0','huyvu8051@gmail.com','2023-05-29 15:45:31'),(9,4,'{\"backgroundColor\":\"#94c748\",\"color\":\"#1d2125\"}','Wanted',NULL,'2023-05-23 11:32:02','\0','huyvu8051@gmail.com','2023-05-29 15:45:34'),(18,4,'{\"backgroundColor\":\"#f87462\",\"color\":\"#1d2125\"}','Binh Nguyen','huyvu8051@gmail.com','2023-05-29 14:52:24','\0','huyvu8051@gmail.com','2023-05-29 15:42:52'),(19,4,'{\"backgroundColor\":\"#f87462\",\"color\":\"#1d2125\"}','VietNam','huyvu8051@gmail.com','2023-05-29 14:52:45','\0','huyvu8051@gmail.com','2023-05-29 15:42:46'),(24,4,'{\"backgroundColor\":\"#faa53d\",\"color\":\"#1d2125\"}','Posco','huyvu8051@gmail.com','2023-05-29 14:59:45','\0','huyvu8051@gmail.com','2023-05-29 15:42:35'),(25,4,'{\"backgroundColor\":\"#e774bb\",\"color\":\"#1d2125\"}','adsfasdfasf','huyvu8051@gmail.com','2023-05-29 15:00:04','','huyvu8051@gmail.com','2023-05-29 15:41:32'),(26,4,'{\"backgroundColor\":\"#e774bb\",\"color\":\"#1d2125\"}','Chung ta ','huyvu8051@gmail.com','2023-05-29 15:41:50','\0','huyvu8051@gmail.com','2023-05-29 15:41:50'),(27,4,'{\"backgroundColor\":\"#216e4e\",\"color\":\"#b6c2cf\"}','small dick','huyvu8051@gmail.com','2023-05-29 15:43:12','','huyvu8051@gmail.com','2023-05-29 15:44:58'),(28,4,'{\"backgroundColor\":\"#e774bb\",\"color\":\"#1d2125\"}','=))','vuvanhuy15082001@gmail.com','2023-05-29 15:46:32','\0','vuvanhuy15082001@gmail.com','2023-05-29 15:46:45'),(29,7,'{\"backgroundColor\":\"#533f04\",\"color\":\"#b6c2cf\"}','Chung ta','huyvu8051@gmail.com','2023-05-31 09:28:49','\0','huyvu8051@gmail.com','2023-05-31 09:28:49'),(30,7,'{\"backgroundColor\":\"#ae2a19\",\"color\":\"#b6c2cf\"}','Buggggg','huyvu8051@gmail.com','2023-05-31 10:02:16','\0','huyvu8051@gmail.com','2023-05-31 10:02:16'),(31,7,'{\"backgroundColor\":\"#94c748\",\"color\":\"#1d2125\"}','Co cai dau bưởi','huyvu8051@gmail.com','2023-05-31 11:20:48','\0','huyvu8051@gmail.com','2023-05-31 11:21:01'),(32,7,'{\"backgroundColor\":\"#f87462\",\"color\":\"#1d2125\"}','Chung ta','huyvu8051@gmail.com','2023-06-12 15:32:07','\0','huyvu8051@gmail.com','2023-06-12 15:32:07');
...
CREATE TABLE `msg` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `frm_num` double NOT NULL,
  `msg_txt` text DEFAULT NULL,
  `sent_dtm` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `conv_id` bigint(20) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `msg_conv_id_fk` (`conv_id`),
  CONSTRAINT `msg_conv_id_fk` FOREIGN KEY (`conv_id`) REFERENCES `conv` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_account` (
  ...
  `modified_date` char(19) DEFAULT NULL,
  `modified_by` varchar(30) DEFAULT NULL,
  `full_nm_fts` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'full name fulltext search',
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_castjbvpeeus0r8lbpehiu0e4` (`username`),
  KEY `id` (`id`),
  KEY `username` (`username`),
  FULLTEXT KEY `user_account_full_nm_fts_index` (`full_nm_fts`)
) ENGINE=InnoDB AUTO_INCREMENT=7396462 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_account` VALUES (7396458,'ng.nguyencntt@gmail.com',NULL,'Gia Nguyễn Nguyễn','https://lh3.googleusercontent.com/a/AGNmyxbZ1gycc7bxclGEX47QyECSTKE-b2mNYm0FZNUO=s96-c','\0','2023-03-09 11:32:14','anonymousUser','2023-06-12 16:22:57',NULL,'ng nguyencntt gmail com Gia Nguyễn Nguyễn ng nguyencntt gmail com gia nguyen nguyen'),(7396459,'huyvu8051@gmail.com',NULL,'Huy Vũ Văn','https://lh3.googleusercontent.com/a/AAcHTtfNlMBYBu7CB4NPlz1Z2B5kxxuZowefxQUpgEVxhw=s96-c','\0','2023-05-30 13:58:04','huyvu8051@gmail.com','2023-06-12 16:22:57',NULL,'huyvu 8051  gmail com Vũ Văn Huy 1508  huyvu 8051  gmail com vu van huy 1508'),(7396460,'huyvu8052@gmail.com',NULL,'Huy Vũ Văn','https://lh3.googleusercontent.com/a/AAcHTtfNlMBYBu7CB4NPlz1Z2B5kxxuZowefxQUpgEVxhw=s96-c','\0','2023-05-30 16:09:17',NULL,'2023-06-12 16:38:01',NULL,'vu'),(7396461,'Chung ta',NULL,NULL,NULL,'\0','2023-06-12 16:40:10',NULL,'2023-06-12 16:41:46',NULL,'Vu');
...
-- Dump completed on 2023-07-28  1:37:12
